...
trace0 = go.Histogram(x=x, nbinsx=100, text=nlog_null_qvals.index)

data = [trace0]

layout = {
    "title": go_dict[test_go_term],
...
<html>
    ...
    + samples_img
    + """", alt = "genes venn", width = "400", height = "400" >
