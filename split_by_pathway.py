...
signaling_sub = [
    ...
    "vascular_smooth_muscle_contratction",
    "ErbB_signaling",
    "ECM-receptor_interaction",
    "GnRH_signaling_pathway",
]
neural_sub = [
    "neuroactive_ligand-reeptor_interaction",
...
for (chrom, start, end, gene, pathway) in (
    l.strip().split("\t") for l in open(regions)
):
