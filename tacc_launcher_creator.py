...
{allocation_line}
{email_line}'''
#SBATCH --mail-user=lohman@utexas.edu
...
Report problems to rt-other@ccbb.utexas.edu''')
    ...
    optional.add_argument('-a', '-A', action='store', dest='allocation', nargs='?', default='RNAseq-of-tapeworm-i', help='The TACC allocation for job submission. You can set a default ALLOCATION environment variable.')
    ...
    optional.add_argument('-e', action='store', dest='email', default='lohman@utexas.edu', help='Your email address if you want to receive an email from Lonestar when your job starts and ends. Without an argument, it will use a default EMAIL_ADDRESS environment variable.')
